...
<div class="container">
<h1>Guidelines</h1>
<p>Welcome to our guidelines page! Please read the following instructions carefully</p>
    
<h2>Voter Registration:</h2>
<ul>
<li>For casting the vote user needs to first register himself. For this registration purpose, the user will be provided a voter registration forn on this website.</li>
...
<li>1.&nbsp;  Registration Phase During this phase the registration of the users (which are going to cast the vote) will be carried out.</li>
...
<li>3.&nbsp; Result Phase: This is the final stage of whole voting process during which the results of election will be displayed at "Result" section </li>
</ul>
</div>
</body>
</html>
